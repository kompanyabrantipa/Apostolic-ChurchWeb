...
const SampleDataGenerator = {
    ...
    generateSampleSermons: function() {
        ...
        return [
            {
                id: 'sermon_' + Date.now() + '_1',
                title: 'Walking by Faith, Not by Sight',
                speaker: 'Pastor Michael Johnson',
                date: new Date(currentDate.getTime() - 7 * 24 * 60 * 60 * 1000).toISOString(), // 1 week ago
                description: `
                    <h3>2 Corinthians 5:7</h3>
                    <p>In this powerful message, Pastor Johnson explores what it truly means to walk by faith and not by sight. Drawing from biblical examples and practical applications, this sermon will challenge you to trust God even when circumstances seem impossible.</p>
                    
                    <h4>Key Points:</h4>
                    <ul>
                        <li>Understanding the difference between faith and sight</li>
                        <li>Biblical examples of faith in action</li>
                        <li>Overcoming doubt and fear</li>
                        <li>Practical steps to strengthen your faith</li>
                    </ul>
                    
                    <p>This message will encourage you to step out in faith and trust God's plan for your life.</p>
                `,
            ...
            {
                id: 'sermon_' + Date.now() + '_2',
                title: 'The Heart of Worship',
                speaker: 'Elder Sarah Williams',
                date: new Date(currentDate.getTime() - 14 * 24 * 60 * 60 * 1000).toISOString(), // 2 weeks ago
                description: `
                    <h3>John 4:23-24</h3>
                    <p>Elder Williams delivers an inspiring message about true worship that comes from the heart. This sermon explores what it means to worship God in spirit and in truth, moving beyond mere ritual to genuine heart connection with our Creator.</p>
                    
                    <h4>Topics Covered:</h4>
                    <ul>
                        <li>The nature of true worship</li>
                        <li>Worship as a lifestyle, not just a Sunday activity</li>
                        <li>Removing barriers to authentic worship</li>
                        <li>The role of gratitude in worship</li>
                    </ul>
                    
                    <p>Be prepared to examine your own heart and discover new depths of worship and praise.</p>
                `,
                videoUrl: '',
                audioUrl: 'https://example.com/sermon-audio-2.mp3',
                thumbnailUrl: 'images/sermon2.jpg',
                status: 'published',
                createdAt: new Date(currentDate.getTime() - 14 * 24 * 60 * 60 * 1000).toISOString(),
                updatedAt: new Date(currentDate.getTime() - 14 * 24 * 60 * 60 * 1000).toISOString()
            }
        ];
    },
